        ...
        <div className="space-y-3.5 my-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-xl font-extrabold text-slate-800 block">${stats.totalLossAmount.toFixed(2)}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 border-t border-slate-100 pt-3">
            ...
            <div>
              ...
              <span className="text-xl font-extrabold text-emerald-700 block">${stats.totalLossSaved.toFixed(2)}</span>
            </div>
          </div>
        </div>
